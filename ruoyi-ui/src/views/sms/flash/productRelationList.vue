...
<script>
  import {fetchList,createFlashProductRelation,deleteFlashProductRelation,updateFlashProductRelation} from '@/api/mall/flashProductRelation';
  import {fetchList as fetchProductList} from '@/api/mall/product';
