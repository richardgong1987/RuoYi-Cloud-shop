...
<script>
  import {fetchList, createProductCate, updateProductCate, getProductCate} from '@/api/mall/productCate';
  import {fetchListWithAttr} from '@/api/mall/productAttrCate';
  import {getProductAttrInfo} from '@/api/mall/productAttr';
